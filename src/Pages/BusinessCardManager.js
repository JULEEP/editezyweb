...
export default function BusinessCardManager() {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 800, margin: "auto", fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      {/* Header */}
      ...
      {showForm && (
        <div style={formContainerStyle}>
          <h3 style={formTitleStyle}>Add New Business Card</h3>
          ...
          <div style={formGridStyle}>
            <div style={formColumnStyle}>
              ...
              <div style={inputGroupStyle}>
                ...
                {form.logo && (
                  <img src={form.logo} alt="Logo preview" style={imagePreviewStyle} />
                )}
              </div>
            </div>
            ...
            <div style={formColumnStyle}>
              <div style={inputGroupStyle}>
                ...
                <div style={iconInputStyle}>
                  <FaWhatsapp style={inputIconStyle} />
                  <input
                    type="text"
                    name="whatsapp"
